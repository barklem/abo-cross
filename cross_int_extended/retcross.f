...
c
	...
	real*4 NSupp,NSlow,CROSS,ALPHA,NSS,NSP,
     ;         CS(46,43),AL(46,43),CS2(46,43),AL2(46,43),
     ;         NSSG(46),NSPG(43)
...
c
	if ((NSS.gt.5.5).or.(NSS.lt.1.).or.(NSP.gt.5.5).or.(NSP.lt.1.3))
     ;   then
	 IFAIL=1
...
c
	call SPLIE2(NSSG,NSPG,CS,46,43,CS2)
	call SPLIE2(NSSG,NSPG,AL,46,43,AL2)	
c
c   run bicubic spline interpolation
c
	call SPLIN2(NSSG,NSPG,CS,CS2,46,43,NSS,NSP,CROSS)
	call SPLIN2(NSSG,NSPG,AL,AL2,46,43,NSS,NSP,ALPHA)
c
	close(15)
	return
	end		
...
c
	...
	real*4 NSupp,NSlow,CROSS,ALPHA,NSD,NSP,
     ;         CS(43,33),AL(43,33),CS2(43,33),AL2(43,33),
     ;         NSPG(43),NSDG(33)
	integer Lupp,Llow,IFAIL,I,J
	character*70 COMMENTS
c
...
c
	if ((NSP.gt.5.5).or.(NSP.lt.1.3).or.(NSD.gt.5.5).or.(NSD.lt.2.3))
     ;   then
	 IFAIL=1
...
c
          do I=1,43
            read(15,*) (CS(I,J),J=1,33)
          end do
          read(15,'(A70)')COMMENTS  ! a single comment line between data
	  do I=1,43
            read(15,*) (AL(I,J),J=1,33)
          end do
c
...
c   setup second derivative table for spline
c
	call SPLIE2(NSPG,NSDG,CS,43,33,CS2)
	call SPLIE2(NSPG,NSDG,AL,43,33,AL2)	
c
c   run bicubic spline interpolation
c
	call SPLIN2(NSPG,NSDG,CS,CS2,43,33,NSP,NSD,CROSS)
	call SPLIN2(NSPG,NSDG,AL,AL2,43,33,NSP,NSD,ALPHA)
c
c
	close(15)
	return
...
c
	...
	real*4 NSupp,NSlow,CROSS,ALPHA,NSD,NSF,
     ;         CS(33,28),AL(33,28),CS2(33,28),AL2(33,28),
     ;         NSDG(33),NSFG(28)
	integer Lupp,Llow,IFAIL,I,J
	character*70 COMMENTS
c
...
c
	if ((NSD.gt.5.5).or.(NSD.lt.2.3).or.(NSF.gt.6.).or.(NSF.lt.3.3))
     ;   then
	 IFAIL=1
...
c
          do I=1,33
            read(15,*) (CS(I,J),J=1,28)
c	    print *,(CS(I,J),J=1,18)
          end do
          read(15,'(A70)')COMMENTS  ! a single comment line between data
	  do I=1,33
            read(15,*) (AL(I,J),J=1,28)
...
c   setup second derivative table for spline
c
	call SPLIE2(NSDG,NSFG,CS,33,28,CS2)
	call SPLIE2(NSDG,NSFG,AL,33,28,AL2)	
c
c   run bicubic spline interpolation
c
	call SPLIN2(NSDG,NSFG,CS,CS2,33,28,NSD,NSF,CROSS)
	call SPLIN2(NSDG,NSFG,AL,AL2,33,28,NSD,NSF,ALPHA)
c
c
	close(15)
	return
